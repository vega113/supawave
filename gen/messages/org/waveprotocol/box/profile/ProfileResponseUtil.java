...
public final class ProfileResponseUtil {
  ...
  public static final class FetchedProfileUtil {
    ...
    public static boolean isEqual(FetchedProfile m1, FetchedProfile m2) {
       ...
       * under the License.
       */
      if (m1.hasFirstName() != m2.hasFirstName()) return false;
      if (m1.hasFirstName() && !m1.getFirstName().equals(m2.getFirstName())) return false;
       ...
       * under the License.
       */
      if (m1.hasLastName() != m2.hasLastName()) return false;
      if (m1.hasLastName() && !m1.getLastName().equals(m2.getLastName())) return false;
       ...
       * under the License.
       */
      if (m1.hasBio() != m2.hasBio()) return false;
      if (m1.hasBio() && !m1.getBio().equals(m2.getBio())) return false;
       ...
       * under the License.
       */
      if (m1.hasLastSeenTime() != m2.hasLastSeenTime()) return false;
      if (m1.hasLastSeenTime() && (m1.getLastSeenTime() != m2.getLastSeenTime())) return false;
      return true;
    }
    ...
    public static int getHashCode(FetchedProfile message) {
       ...
       * under the License.
       */
      result = (31 * result) + (message.hasFirstName() ? message.getFirstName().hashCode() : 0);
       ...
       * under the License.
       */
      result = (31 * result) + (message.hasLastName() ? message.getLastName().hashCode() : 0);
       ...
       * under the License.
       */
      result = (31 * result) + (message.hasBio() ? message.getBio().hashCode() : 0);
       ...
       * under the License.
       */
      result = (31 * result) + (message.hasLastSeenTime() ? Long.valueOf(message.getLastSeenTime()).hashCode() : 0);
      return result;
    }
