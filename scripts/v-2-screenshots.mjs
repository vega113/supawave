...
// 7. Demonstrate the debug-overlay flag: toggle the body class directly
// to mirror what HtmlRenderer does when j2cl-debug-overlay is enabled.
// Same DOM, same CSS rule, opposite branch — the dev strings reappear.
await page.evaluate(() => {
...
// 6. Dump the rendered HTML for grep verification.
