...
/**
 * Jakarta override of the welcome robot that adds a "Welcome" wave to new users.
 *
 * <p>In this version, {@code setupOAuth()} is a no-op (handled by the Jakarta
 * {@link com.google.wave.api.AbstractRobot}), and all operations go through
 * {@link com.google.wave.api.LocalWaveService} via
...
public class WelcomeRobot extends AbstractBaseRobotAgent {
  ...
  public void greet(ParticipantId id) throws IOException {
    ...
    // rpcUrl is passed through but ignored by LocalWaveService.
    ...
    if (account != null) {
      // setupOAuth is a no-op in the Jakarta override; operations go through LocalOperationSubmitter.
