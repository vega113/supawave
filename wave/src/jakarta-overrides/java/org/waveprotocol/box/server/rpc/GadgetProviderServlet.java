...
/**
 * Jakarta variant of GadgetProviderServlet.
 */
@SuppressWarnings("serial")
@Singleton
public class GadgetProviderServlet extends HttpServlet {

  private static final Logger LOG = Logger.getLogger(GadgetProviderServlet.class.getName());

  private final LoadingCache<String, String> jsonCache = CacheBuilder.newBuilder()
