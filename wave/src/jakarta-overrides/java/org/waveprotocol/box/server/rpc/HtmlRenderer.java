...
public final class HtmlRenderer {
  ...
  private static final String ICON_CLOUD_CHECK =
      ...
      + "</svg>";
  /** WiFi/signal icon for connection status — green #3fb950. */
  ...
  /** WiFi-off icon for disconnected state — red #f85149. */
  private static final String ICON_WIFI_OFF =
      "<svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"#f85149\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\">"
