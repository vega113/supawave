...
public interface EventHandler {
  ...
  /**
   * Handler for {@link BlipEditingDoneEvent}.
   *
   * <p>Fired when all editing sessions on a blip have completed (all {@code user/d/}
   * annotations have their end timestamps filled in).
   *
