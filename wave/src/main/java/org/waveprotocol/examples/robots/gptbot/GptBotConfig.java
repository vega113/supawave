...
public final class GptBotConfig {
  ...
  /**
   * Deprecated: BLIP_SUBMITTED events are no longer generated by the Wave server.
   * This flag is retained for configuration compatibility but has no effect — the robot
   * always processes DOCUMENT_CHANGED as the authoritative blip-committed signal.
   *
   * @deprecated BLIP_SUBMITTED is phased out; DOCUMENT_CHANGED is always processed.
   */
  @Deprecated
