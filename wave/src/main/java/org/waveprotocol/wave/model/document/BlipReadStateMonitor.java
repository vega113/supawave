 ...
 *
 * <p>This interface lives in the model package so that {@link WaveContext} can
 * reference it without creating a model→client compile dependency.  The
 * client-side implementation is in
 * {@code org.waveprotocol.wave.client.state.BlipReadStateMonitorImpl}.
 */
