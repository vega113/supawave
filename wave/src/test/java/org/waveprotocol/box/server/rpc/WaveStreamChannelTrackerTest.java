...
public final class WaveStreamChannelTrackerTest {

  @Test
  public void acceptsNewChannelIdAfterWaveStreamReopens() {
    ...
    tracker.onStreamOpened(waveId);

    assertFalse(tracker.shouldDropUpdate(waveId, "channel-2"));
  }

  @Test
  public void keepsUpdatesWithoutChannelIdsAfterWaveStreamReopens() {
    WaveStreamChannelTracker tracker = new WaveStreamChannelTracker();
    WaveId waveId = WaveId.of("example.com", "w+saved-state");
